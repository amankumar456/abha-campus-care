import { Menu, X, Search, LogIn, UserPlus, GraduationCap, Stethoscope, LogOut, User, Users, Settings, Shield, Pill, LayoutDashboard, Package, ClipboardList } from "lucide-react";
